					...
					<form method="post" action="<?php echo base_url('admin/surat/print_surat'); ?>">
						<table align="center" style="width: 800px;">
							...
							<tr>
								...
								<td colspan="3">
									<div class="input-control text" style="width: 100%;">
										<input name="tujuan" type="text" required>
									</div>	
								</td>
								<td colspan="2" align="center">
									<input type="radio" name="kategori" value="1" required> Rektorat &nbsp;&nbsp; <input type="radio" name="kategori" value="2" required> Non Rektorat
								</td>
							</tr> -->
