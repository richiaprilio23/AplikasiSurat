...
<!-- START CONTENT -->                		
    		<div class="cell auto-size padding20 bg-white" id="cell-content">
                    ...
                    <div class="dropdown-button">
					    <button class="button success dropdown-toggle"><span class="mif-plus"></span> Buat Surat Baru</button>
                    ...
                    <table id="example_table" class="dataTable striped border bordered" data-role="datatable" data-searching="true"> 
                        ...
                        <tr>
                            ...
                            <a href="<?php echo base_url('admin/surat/delete_surat_keluar/'.$row->id_surat_keluar); ?>" onclick="return confirm('Hapus?')"><button class="button danger">Delete</button></td></a>
                        </tr>
                        <?php }?>
                        </tbody>
                    </table>
