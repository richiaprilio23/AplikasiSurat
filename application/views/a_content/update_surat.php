<?php 
	foreach ($isi_surat -> result() as $row){
		$id			= $row->id_surat_keluar;
		$no 		= $row->no_surat_keluar;
		$isi 		= $row->isi_surat_keluar;
		$tgl		= $row->tanggal_surat_keluar;
		$lampiran	= $row->lampiran_surat_keluar;
		$perihal	= $row->perihal_surat_keluar;
		$alamat 	= $row->alamat_surat_keluar;
		$keterangan = $row->keterangan_surat_keluar;
	}
		...
		<div class="row" style="height: 100%">
			...
			<div class="cell auto-size padding20 bg-white" id="cell-content">
				...
				<hr class="thin bg-grayLighter">
					...
					<form method="post" action="<?php echo base_url('admin/surat/update_print_surat/'.$id); ?>">
						<table align="center" style="width: 800px;">
							<tr>
								...
								<td hidden>
									<div class="input-control text" style="width: 100%;">
										<input id="no1" name="kode_skep" type="text" value="">
									</div>	
								</td>
								<td >
									<div class="input-control text" style="width: 100%;">
										<input id="no1" name="no_urut" type="text" value="<?php echo $no_1;?>" required>
									</div>	
								</td>
								<td >
									<div class="input-control text" style="width: 100%;">
							...
							<tr>
								...
								<td colspan="2">
									<div class="input-control text" id="datepicker" style="width: 100%;" data-format="dd-mm-yyyy" data-preset="<?php echo $tanggal;?>">
							...
							<tr>
								...
								<td colspan="5">
									<div class="input-control text" style="width: 100%;">
										<input name="lampiran" type="text" value="<?php echo $lampiran;?>" required>
									</div>	
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									<div class="input-control text" style="width: 100%;">
										<input name="tujuan" type="text" value="<?php echo $alamat;?>" required>
									</div>	
								</td>
								<td colspan="2" align="center">
									<input type="radio" name="kategori" value="1" <?php if($keterangan==1)echo "checked";?> required> Rektorat &nbsp;&nbsp; 
									<input type="radio" name="kategori" value="2" <?php if($keterangan==2)echo "checked";?> required> Non Rektorat
								</td>
							</tr>
						</table>
						...
						<div align="right">
							...
							<button type="submit" class="button primary" ><span class="mif-download2" ></span> Update</button>
						</div>
					</form>
			</div>
			<!-- END CONTENT -->
